 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _=b("Upload",[["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["polyline",{points:"17 8 12 3 7 8",key:"t8dd8p"}],["line",{x1:"12",x2:"12",y1:"3",y2:"15",key:"widbto"}]]);function Pe(){const C=F(),c=o.useRef(null),[S,P]=o.useState(!0),[g,f]=o.useState(!1),[z,m]=o.useState(!1),[v,n]=o.useState(""),[x,L]=o.useState(""),[d,j]=o.useState("exchange-paper"),[u,E]=o.useState(!1),[a,l]=o.useState({logo_base64:"",business_name:"",phone:"",business_address:"",business_city:"",business_postal_code:""}),[r,i]=o.useState({title:"Besoin d'echanger votre article ?",subtitle:"Scannez le QR code ci-dessous",instruction1:"1. Scannez le QR code avec votre telephone",instruction2:"2. Remplissez le formulaire d'echange",instruction3:"3. Nous vous contacterons sous 24h",footerText:"Service client disponible 7j/7",showLogo:!0,showPhone:!0});o.useEffect(()=>{R()},[]);const R=async()=>{try{const{data:{session:s}}=await p.auth.getSession();if(!s){C("/merchant/login");return}const{data:t}=await p.from("merchants").select("*").eq("email",s.user.email).maybeSingle();t&&(L(t.id),l({logo_base64:t.logo_base64||"",business_name:t.business_name||t.name||"",phone:t.phone||"",business_address:t.business_address||"",business_city:t.business_city||"",business_postal_code:t.business_postal_code||""}))}catch(s){console.error("Error fetching merchant data:",s),n("Erreur lors du chargement des donnees")}finally{P(!1)}},$=s=>{var w;const t=(w=s.target.files)==null?void 0:w[0];if(!t)return;if(t.size>5e5){n("L'image ne doit pas depasser 500 Ko");return}const h=new FileReader;h.onloadend=()=>{l(I=>({...I,logo_base64:h.result})),n("")},h.readAsDataURL(t)},T=()=>{l(s=>({...s,logo_base64:""})),c.current&&(c.current.value="")},N=()=>{const s=`https://fawzyoth.github.io/Swapp-app/#/client/exchange/new?merchant=${x}`;return console.log("QR Code URL:",s,"MerchantId:",x),s},A=()=>{const s=window.open("","","height=800,width=600");s&&(s.document.write(`
        <html>
        <head>
