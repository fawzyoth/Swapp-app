import{d as N,u as y,r,s as n,j as e}from"./index-CGuTpfce.js";import{A as l}from"./AdminLayout-U_fO2Lid.js";import{F as p}from"./file-text-CNKwjRK0.js";import{A as w}from"./arrow-left-BpEP3EcE.js";import{C as u}from"./calendar-CNHCk6yJ.js";import{P as _}from"./package-BUge56jo.js";import{B as D}from"./banknote-C3qg8fnc.js";import{P as F}from"./printer-BtaeswGC.js";import{D as k}from"./download-OyIyVcFR.js";import{S as P}from"./send-Cq53Vb81.js";import{C as f}from"./check-circle-C8LdpYcK.js";import{C as S}from"./clock-D5l6KAfG.js";import"./x-BDYXHXVZ.js";import"./createLucideIcon-D9R5Vyj_.js";import"./menu-BDfgw-7m.js";import"./shield-tj2Ggf38.js";import"./layout-dashboard-C14bcGdN.js";import"./users-B34gaGxt.js";import"./truck-T6aPcJoR.js";import"./wallet-rOluuaMK.js";import"./store-B7RLKw5c.js";import"./home-Bw_Q-z1r.js";function X(){const{id:a}=N(),o=y(),[b,h]=r.useState(!0),[s,g]=r.useState(null),[d,c]=r.useState(!1);r.useEffect(()=>{a&&m()},[a]);const m=async()=>{try{const{data:t,error:i}=await n.from("weekly_invoices").select("*").eq("id",a).maybeSingle();if(i)throw i;g(t)}catch(t){console.error("Error fetching invoice:",t)}finally{h(!1)}},v=async()=>{if(s){c(!0);try{const{error:t}=await n.from("weekly_invoices").update({status:"paid",paid_at:new Date().toISOString(),paid_amount:s.net_payable}).eq("id",a);if(t)throw t;await n.from("financial_transactions").insert({invoice_id:s.id,transaction_type:"invoice_paid",amount:s.net_payable,currency:"TND",direction:"credit",status:"completed",description:`Paiement facture ${s.invoice_number}`}),m(),alert("Facture marquée comme payée")}catch(t){console.error("Error updating invoice:",t),alert("Erreur lors de la mise à jour")}finally{c(!1)}}},x=()=>{if(!s)return;const t=window.open("","_blank");if(!t)return;const i=`
      <!DOCTYPE html>
      <html>
      <head>
