...
import {
  BarChart3, Package, CheckCircle, XCircle, Clock,
  Users, Truck, MapPin
} from 'lucide-react';
...
export default function MerchantDashboard() {
  ...
  const fetchStats = async () => {
    try {
      ...
      if (exchanges) {
        ...
        const validated = exchanges.filter(e => e.status === 'validated' || e.status === 'preparing' || e.status === 'in_transit' || e.status === 'completed').length;
        ...
        setStats({ total, pending, validated, rejected, completed, validationRate });
  ...
  return (
    <MerchantLayout>
      <div>
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-slate-900 mb-2">Vue d'ensemble</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl font-bold text-slate-900">{stats.validated}</span>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow p-6">
            <h3 className="text-lg font-bold text-slate-900 mb-4">Taux de validation</h3>
            <div className="flex items-center gap-4">
              ...
              <span className="text-2xl font-bold text-slate-900">{stats.validationRate}%</span>
            </div>
          </div>

          <div className="bg-white rounded-xl shadow p-6">
            <h3 className="text-lg font-bold text-slate-900 mb-4">Échanges complétés</h3>
            <div className="flex items-center gap-4">
          ...
          <div className="bg-white rounded-xl shadow p-6">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span className="font-medium text-slate-900">Gérer les échanges</span>
              </Link>
              <Link
                to="/merchant/clients"
                className="flex items-center gap-3 p-4 bg-slate-50 hover:bg-slate-100 rounded-lg transition-colors"
              >
                ...
                <span className="font-medium text-slate-900">Voir les clients</span>
              </Link>
              <Link
              ...
              >
                ...
                <span className="font-medium text-slate-900">Mode simulation</span>
              </Link>
            </div>
          </div>
        </div>
